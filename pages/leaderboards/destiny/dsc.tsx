...
export const DSCLeaderboards = (props: DestinyLeaderboardsProp) => (
  <OffCanvas>
    <Head>
      <title>Deep Stone Crypt Leaderboards | Level Crush</title>
    </Head>
    <SiteHeader />
    <main>
      <Hero className="min-h-[20rem]">
        <Container className="px-4 mx-auto flex-initial" minimalCSS={true}>
          <H2 className="drop-shadow  text-center">
            Deep Stone Crypt Leaderboard
          </H2>
        </Container>
      </Hero>
      <Container>
        <H3>Destiny 2 Deep Stone Crypt Leaderboards speedruns</H3>
        <p>
      ...
      <Container>
        <SpeedRunTable
          title="Destiny 2 - Deep Stone Crypt"
          id="destinySpeedRunsDSC"
...
export default DSCLeaderboards;
