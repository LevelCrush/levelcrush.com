...
export const VOTDLeaderboards = (props: DestinyLeaderboardsProp) => (
  <OffCanvas>
    <Head>
      <title>Vow of the Disciple Leaderboards | Level Crush</title>
    </Head>
    <SiteHeader />
    <main>
      <Hero className="min-h-[20rem]">
        <Container className="px-4 mx-auto flex-initial" minimalCSS={true}>
          <H2 className="drop-shadow  text-center">
            Vow of the Disciple Leaderboard
          </H2>
        </Container>
      </Hero>
      <Container>
        <H3>Destiny 2 Vow of the Disciple speedruns</H3>
        <p>
      ...
      <Container>
        <SpeedRunTable
          title="Destiny 2 - Vow of the Disciple"
          id="destinySpeedRunsVOTD"
...
export default VOTDLeaderboards;
